...
>;
export declare function parseSort<Tables extends string[]>(
  sort: SortType<Tables>,
): string;
export declare function parseGroupBy<Tables extends string[]>(
  groupBy: FindAllParamsType<Tables>["groupBy"],
): string;
export declare function isTableInJoin(sql: string, tableName: string): boolean;
export declare function parseJoins<Tables extends string[]>(
  joins: JoinsType<Tables>,
): string;
export declare function parseColumns<Tables extends string[]>(
